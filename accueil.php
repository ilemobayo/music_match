...
require_once('inc/mainHeader.inc.php');
require_once('inc/nav.inc.php');
?>                                
<!--Main Section  -->
<div class="wrapper">
    <div class="page-header section-dark" style="background-image: url('assets/img/backG/main_bg.jpg')">
        ...
        <section class="container-fluid">
            ...
            <div class="container flex">
                <div class="flexItem">
                    <img src="assets/img/music_tree.png" alt="">
                </div>
                 <div class="flexItem">
        ...
        <section class="container-fluid vinyl">
            <div class="container flex">
                <div class="flexItem">
                    <img src="assets/img/placeholder.jpg" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
